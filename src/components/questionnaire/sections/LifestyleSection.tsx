    ...
    <div className="space-y-6">
      ...
      <Alert className="border-blue-200 bg-blue-50">
        ...
        <AlertDescription className="text-blue-900">
          Your daily habits including caffeine consumption, alcohol use, and exercise patterns 
          can significantly impact your sleep quality and timing.
        </AlertDescription>
      </Alert>
      ...
      <div className="space-y-4 p-4 border rounded-lg bg-gray-50">
        <div className="flex items-center space-x-2">
          ...
          <h3 className="font-medium">Caffeine Consumption</h3>
        </div>
      ...
      <div className="space-y-4 p-4 border rounded-lg bg-gray-50">
        <div className="flex items-center space-x-2">
          ...
          <h3 className="font-medium">Alcohol Consumption (Weekly)</h3>
        </div>
      ...
      <div className="space-y-4 p-4 border rounded-lg bg-gray-50">
        <div className="flex items-center space-x-2">
          ...
          <h3 className="font-medium">Exercise Habits</h3>
        </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Late evening exercise can interfere with sleep
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
      ...
      {lateCaffeine && (
        <Alert className="border-amber-200 bg-amber-50">
          ...
          <AlertDescription className="text-amber-900">
            ...
            meaning it can significantly impact your ability to fall asleep and sleep quality. 
            Try to have your last caffeinated beverage before noon.
          </AlertDescription>
        </Alert>
      )}
      ...
      {totalAlcohol > 14 && (
        <Alert className="border-red-200 bg-red-50">
          ...
          <AlertDescription className="text-red-900">
            ...
            initially help you fall asleep, it significantly disrupts sleep architecture, 
            reducing REM sleep and causing frequent awakenings. Consider reducing alcohol 
            intake, especially within 3 hours of bedtime.
          </AlertDescription>
        </Alert>
      )}
      ...
      {totalAlcohol > 7 && totalAlcohol <= 14 && (
        <Alert>
          ...
          <AlertDescription>
            Moderate alcohol consumption can still impact sleep quality. Alcohol disrupts 
            sleep cycles and can cause early morning awakenings. Try to avoid alcohol 
            within 3 hours of bedtime for better sleep.
          </AlertDescription>
        </Alert>
      )}
      ...
      {exerciseDaysPerWeek === 0 && (
        <Alert className="border-amber-200 bg-amber-50">
          ...
          <AlertDescription className="text-amber-900">
            ...
            exercise like a 30-minute walk can significantly improve sleep. Try to incorporate 
            some physical activity into your daily routine, preferably in the morning or afternoon.
          </AlertDescription>
        </Alert>
      )}
      ...
      {exerciseDaysPerWeek >= 5 && (
        <Alert className="border-green-200 bg-green-50">
          ...
          <AlertDescription className="text-green-900">
            ...
            <br />
            You&apos;re exercising regularly, which is excellent for sleep quality. Just make 
            sure to finish vigorous exercise at least 3 hours before bedtime to allow your 
            body temperature and arousal levels to decrease.
          </AlertDescription>
        </Alert>
      )}
      ...
      {form.watch('lifestyle.exerciseEndTime') && 
       parseInt(form.watch('lifestyle.exerciseEndTime')?.split(':')[0] ?? '0') >= 20 && (
        <Alert>
          ...
          <AlertDescription>
            Exercising within 3 hours of bedtime can make it harder to fall asleep. 
            Your body temperature and arousal levels need time to decrease after exercise. 
            Try to schedule workouts earlier in the day if possible.
          </AlertDescription>
        </Alert>
      )}
    </div>
