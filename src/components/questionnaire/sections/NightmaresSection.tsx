        ...
        <>
          ...
          <div className="border-border bg-card/50 rounded-xl border p-5 space-y-3">
            ...
            <div className="space-y-2 text-sm text-foreground/80">
              ...
              <p>
                <strong>Nightmares</strong> are bad dreams that also involve waking up feeling
                scared, panicked, or upset.
              </p>
            </div>
          </div>
          ...
          {hasBadDreams && badDreamsPerWeek >= 3 && (
            <Alert className="alert-warning">
              ...
              <AlertDescription className="text-amber-900">
                ...
                <br />
                You endorsed symptoms of having frequent bad dreams. This can be a sign of a history
                of trauma, a mental health condition, or may be caused by some medications. Please
                see the section on our website that has more information on dreams and nightmares.
              </AlertDescription>
            </Alert>
          )}
          ...
          {hasNightmares && nightmaresPerWeek >= 2 && (
            <Alert className="alert-warning">
              ...
              <AlertDescription className="text-amber-900">
                ...
                <br />
                You endorsed symptoms of a nightmare parasomnia/disorder. This can be a sign of a
                history of trauma, a mental health disorder, and can be caused by some medications.
                Frequent nightmares can be distressing and associated with stress, trauma, and mood
                disturbance. Please see the section on our website that has more information on
                nightmares. If your nightmares are distressing, we suggest that you consult with a
          ...
          {hasNightmares && nightmaresPerWeek > 0 && nightmaresPerWeek < 2 && (
            <Alert>
              ...
              <AlertDescription>
                ...
                distress as a result of your nightmares, we recommend that you consult with a
                behavioral sleep specialist or mental health professional.
              </AlertDescription>
            </Alert>
          )}
          ...
          {associatedWithTrauma && (
            <Alert className="alert-danger">
              ...
              <AlertDescription className="text-red-900">
                ...
                <br />
                Trauma and PTSD are serious mental health challenges that require treatment by a
                provider who specializes in treatment of trauma. Nightmares are one of many symptoms
                of PTSD and trauma, and for most people, treatment of PTSD with evidence-based
                therapies is a high priority. Please consider seeking help from a qualified mental
                health professional who specializes in trauma.
              </AlertDescription>
            </Alert>
          )}
        </>
