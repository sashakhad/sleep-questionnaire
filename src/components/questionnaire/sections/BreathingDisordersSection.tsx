    ...
    <div className="space-y-6">
      ...
      <Alert className="border-blue-200 bg-blue-50">
        ...
        <AlertDescription className="text-blue-900">
          Diagnosis and treatment of sleep related breathing disorders is exceedingly important 
          as they contribute to significant health problems.
        </AlertDescription>
      </Alert>
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-base">
                  Are you being treated for your sleep breathing problem? (check all that apply)
                </FormLabel>
      ...
      {!diagnosed && (form.watch('breathingDisorders.snores') || form.watch('breathingDisorders.stopsBreathing')) && (
        <Alert className="border-amber-200 bg-amber-50">
          <AlertCircle className="h-4 w-4 text-amber-600" />
          <AlertDescription className="text-amber-900">
            Based on your responses, we recommend that you discuss treatment options with 
            your sleep specialist or primary care doctor. Sleep breathing disorders can 
