...
export function RestlessLegsSection({ form }: RestlessLegsSectionProps) {
  ...
  const hasSymptoms = form.watch('restlessLegs.troubleLyingStill') || 
    ...
    <div className="space-y-6">
      ...
      <Alert className="border-blue-200 bg-blue-50">
        ...
        <AlertDescription className="text-blue-900">
          Restless legs syndrome is a relatively common disorder that increases discomfort 
          in bed and interferes with your ability to fall asleep. RLS can be associated with 
          insufficient availability of dopamine, low levels of ferritin, pregnancy, or as an 
          unwanted effect of some medications including SSRIs.
        </AlertDescription>
      </Alert>
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-base">
                  Are you being treated for RLS? (check all that apply)
                </FormLabel>
      ...
      {!diagnosed && hasSymptoms && (
        <Alert className="border-amber-200 bg-amber-50">
          ...
          <AlertDescription className="text-amber-900">
            Your answers suggest that you may have restless legs syndrome. We strongly 
            encourage you to discuss treatment options with your sleep specialist or primary 
            care doctor. RLS is often exacerbated when someone is sleep deprived, using 
            excessive caffeine, or experiencing increased stress.
          </AlertDescription>
        </Alert>
      )}
      ...
      {diagnosed && form.watch('restlessLegs.treatment')?.length === 0 && (
        <Alert>
          ...
          <AlertDescription>
            You have been diagnosed with RLS but are not currently receiving treatment. 
            Treatment can significantly improve your sleep quality. Consider discussing 
