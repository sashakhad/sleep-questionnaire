...
export function SleepDisorderDiagnosesSection({ form }: SleepDisorderDiagnosesSectionProps) {
  ...
  const hasSelectedOSA = diagnosedDisorders.includes('obstructive_sleep_apnea');
  const hasSelectedRLS = diagnosedDisorders.includes('rls');
  ...
  return (
    <div className='space-y-6'>
      ...
      {/* OSA treatment follow-up (shown when OSA is checked in the list above) */}
      {hasSelectedOSA && (
        <div className='border-border bg-card/50 space-y-4 rounded-xl border p-5'>
      ...
      {/* RLS treatment follow-up (shown when RLS is checked in the list above) */}
      {hasSelectedRLS && (
        <div className='border-border bg-card/50 space-y-4 rounded-xl border p-5'>
          <h3 className='text-muted-foreground text-sm font-semibold tracking-wide uppercase'>
            Restless Legs Syndrome Treatment Details
          </h3>
