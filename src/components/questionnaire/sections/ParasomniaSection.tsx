    ...
    <div className="space-y-6">
      ...
      <Alert className="border-blue-200 bg-blue-50">
        ...
        <AlertDescription className="text-blue-900">
          Parasomnias are unusual behaviors during sleep that can affect your safety and sleep quality. 
          These include sleepwalking, sleep talking, night terrors, and other behaviors.
        </AlertDescription>
      </Alert>
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel className="text-base">
              Have you been told that you wake in the middle of the night and: (check all that apply)
            </FormLabel>
      ...
      {remembersEvents && actsOutDreams && (
        <Alert className="border-red-200 bg-red-50">
          ...
          <AlertDescription className="text-red-900">
            ...
            <br />
            Your answers suggest you should be evaluated for REM Behavioral Disorder (RBD), 
            which is more common among men over 65. The immediate risk is injury to yourself 
            or a bed partner. We suggest you prioritize discussing your symptoms with a sleep 
            specialist or neurologist who may order a sleep study.
          </AlertDescription>
        </Alert>
      )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="e.g., medication, behavioral therapy..."
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
      ...
      {(hasNightBehaviors || diagnosedParasomnia) && !receivedTreatment && (
        <Alert className="border-amber-200 bg-amber-50">
          ...
          <AlertDescription className="text-amber-900">
            ...
            <br />
            The most important initial step is to assure your safety and others who live in your home. 
            Some parasomnias (nocturnal eating and cooking, sleepwalking) can result in injuries. 
            Until you receive treatment, take safety measures by using alarms and alerting others 
            in your home that you should be observed or calmly guided back to bed.
          </AlertDescription>
        </Alert>
      )}
    </div>
