  ...
  return (
    <div className='space-y-8'>
      <div className='flex items-center gap-3'>
        ...
        <div>
          <p className='text-foreground text-lg font-semibold'>Daytime Energy and Alertness</p>
          <p className='text-muted-foreground text-sm'>
            Remember to think about the average over a typical week.
          </p>
        </div>
      </div>
      ...
      {/* Sleepiness and fatigue 1-10 scales */}
      <div className='border-border bg-card/50 space-y-6 rounded-xl border p-5'>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className='text-base font-medium'>
                I experience sleepiness (heavy eyes, the urge to fall asleep)…
              </FormLabel>
              <FormDescription className='text-muted-foreground'>
                1 = Never, 5 = Sometimes, 10 = Often
              </FormDescription>
        ...
        <FormField
          control={form.control}
          name='daytime.sleepinessInterference'
          render={({ field }) => (
            <FormItem>
              <FormLabel className='text-base font-medium'>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className='text-base font-medium'>
                I experience fatigue/tiredness (feeling of physical or mental exhaustion or very low
                energy)…
              </FormLabel>
              <FormDescription className='text-muted-foreground'>
                1 = Never, 5 = Sometimes, 10 = Often
        ...
        <FormField
          control={form.control}
          name='daytime.fatigueInterference'
          render={({ field }) => (
            <FormItem>
              <FormLabel className='text-base font-medium'>
                My fatigue/tiredness interferes with my daily activities…
              </FormLabel>
              <FormDescription className='text-muted-foreground'>
                1 = Never, 5 = Sometimes, 10 = Often
              </FormDescription>
        ...
        {/* Critical safety warning for sleepiness or fatigue interference >= 8 */}
        {((form.watch('daytime.sleepinessInterference') ?? 0) >= 8 ||
          (form.watch('daytime.fatigueInterference') ?? 0) >= 8) && (
          <Alert className='border-red-200/80 bg-red-50/80'>
            ...
            <AlertDescription className='text-red-900'>
              ...
              You should seek immediate help from a healthcare professional. Until you have done so,
              you should consider avoiding potentially dangerous activities such as driving, biking,
              or jobs involving high-risk activities like construction or operating heavy equipment.
              <br />
              <br />
      ...
      {form.watch('daytime.sleepParalysis') && (
        <NumberField
          control={form.control}
          name='daytime.sleepParalysisFrequency'
          label='How many times in the last month have you experienced sleep paralysis?'
          min={0}
          max={30}
          placeholder='0-30'
        />
      ...
      <div className='border-border bg-card/50 space-y-4 rounded-xl border p-5'>
        ...
        <CheckboxField
          ...
          description='Non-restorative sleep can reflect misconceptions about sleep that are common with insomnia.'
        />
      ...
      {form.watch('daytime.nonRestorativeSleep') &&
        ...
        form.watch('daytime.fatigueInterference') !== null &&
        form.watch('daytime.fatigueInterference')! >= 5 && (
