...
export const diagnosisScenarios: DiagnosisScenario[] = [
  ...
  },
  {
    ...
    description: 'SOL in the mild range with two daytime symptoms.',
    data: createBaseScenarioData({
      scheduledSleep: {
  ...
  },
  {
    ...
    data: createBaseScenarioData({
      daytime: {
        sleepinessInterferes: true,
        fallAsleepDuring: ['stoplight', 'meal', 'conversation', 'lectures'],
  ...
  },
  {
    ...
    description: 'Pain plus multiple fatigue indicators should flag chronic fatigue.',
    data: createBaseScenarioData({
      daytime: {
        sleepinessInterferes: true,
        tirednessRating: 8,
  ...
  {
    id: 'dspd-differential-dspd-primary',
    label: 'DSPD-primary insomnia differential',
    description:
      'Insomnia with delayed chronotype and DSPD differential criteria met should attribute to DSPD.',
    data: createBaseScenarioData({
      chronotype: {
        preference: 'late',
        preferenceStrength: 'moderate',
  ...
  {
    id: 'dspd-differential-insomnia-primary',
    label: 'Insomnia-primary over DSPD differential',
    description:
      'Insomnia anchor with delayed chronotype but DSPD differential not met should favor insomnia.',
    data: createBaseScenarioData({
      chronotype: {
        preference: 'late',
        preferenceStrength: 'moderate',
  ...
  {
    id: 'insufficient-sleep-signs',
    label: 'Subclinical insufficient sleep signs',
    description:
      'Short scheduled sleep with daytime tiredness should flag insufficient sleep signs without syndrome.',
    data: createBaseScenarioData({
      scheduledSleep: {
        lightsOutTime: '01:00',
        minutesToFallAsleep: '10',
